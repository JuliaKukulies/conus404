...
#PBS -j oe
#PBS -r y
#PBS -o log_files/moaap_features_2002_2018_AR_OBS.log
#PBS -m n
...
### Run program
/glade/work/kukulies/conda-envs/tobac/bin/python get_statistics_moaap_features_obs.py AR $PBS_ARRAY_INDEX
