...
#PBS -j oe
#PBS -r y
#PBS -o log_files/moaap_features_2000_2022_midlevel_cyclones.log
#PBS -m n 
...
### Run program
/glade/work/kukulies/conda-envs/tobac/bin/python get_statistics_moaap_features.py CY_z500 $PBS_ARRAY_INDEX
